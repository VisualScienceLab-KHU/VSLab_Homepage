      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">MyeongAh Cho</span>
  ...
  <div class="wrap">
    ...
    <div class="team-grid">
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">MyoungChul Kim</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">KunHo Heo</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Wongyu Lee</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Seungjae Kim</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Junhee Lee</span>
            <a class="profile-icon-link"
  ...
  <div class="wrap">
    ...
    <div class="team-grid">      
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Hayoung Lee</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        <div class="profile-photo">
          <img src="{{ '/assets/img/team/cg.png' | relative_url }}" alt="ChaeGyeong Lee"
               onerror="this.style.display='none'; this.parentElement.classList.add('is-empty');">
        </div>

        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">ChaeGyeong Lee</span>
            <!-- 링크 없으면 아이콘 제거해도 됨 -->
          </div>

          <div class="profile-role"></div>
          <div class="profile-email">leecg1219 (at) khu.ac.kr</div>
        </div>
      </article>
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Hangjun Jo</span>
            <a class="profile-icon-link"
               href="https://everjun2.github.io/"
               target="_blank" rel="noopener"
               aria-label="Personal website">
              <svg class="profile-icon" viewBox="0 0 442.246 442.246" aria-hidden="true">
                <path d="M409.657,32.474c-43.146-43.146-113.832-43.146-156.978,0l-84.763,84.762c29.07-8.262,60.589-6.12,88.129,6.732
  ...
  <div class="wrap">
    ...
    <div class="team-grid">
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Youngbin Kim</span>
            <a class="profile-icon-link"
      ...
      <article class="profile">
        ...
        <div class="profile-body">
          <div class="profile-name-row">
            <span class="profile-name">Taeyeong Kim</span>
            <a class="profile-icon-link"
